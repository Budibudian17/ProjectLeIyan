...
const hero = {
  image: "/img/aboutuss1.webp",
  title: "Tentang Abufa Plywood",
  description:
    "Kenal lebih dekat dengan Abufa Plywood, partner material kayu lembaran untuk kebutuhan proyek rumah, interior, dan konstruksi Anda.",
};
